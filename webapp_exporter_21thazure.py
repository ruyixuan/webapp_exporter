...
class AzureWebAppExporter:
    def __init__(self, config_path="webapp_config.json", port=9200):
    ...
    async def get_azure_metrics(self, session, web_app_config, interval):
        ...
        for web_app_name in web_app_names:
            url = f"https://management.chinacloudapi.cn/subscriptions/{subscription_id}/resourceGroups/{resource_group_name}/providers/Microsoft.Web/sites/{web_app_name}/providers/microsoft.insights/metrics"
            params = {
